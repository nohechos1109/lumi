...
import { getSaleNote, listNoteLines } from '@/lib/queries/sale-notes'
import { getSale } from '@/lib/queries/sales'
import SaleNotePDF from '@/components/pdf/SaleNotePDF'
...
export async function GET(
  ...
  const element = createElement(SaleNotePDF, { note, lines, sale, logoPath })
