      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.topInfo}>
          ...
          <View style={styles.column}>
            ...
            <Text style={styles.label}>NOTA DE COBRO</Text>
            <Text style={[styles.value, { fontWeight: 'bold' }]}>{note.number}</Text>
        ...
        <View style={styles.totalsArea} wrap={false}>
          <View style={styles.totalsBox}>
            <View style={styles.totalEntry}>
              ...
              <Text style={styles.value}>${fmt(note.amount_untaxed)} MXN</Text>
            </View>
            <View style={styles.totalEntry}>
              <Text style={styles.label}>IVA (16%):</Text>
              <Text style={styles.value}>${fmt(note.amount_tax)} MXN</Text>
            </View>
            <View style={styles.grandTotal}>
              <Text style={[styles.grandTotalText, { fontSize: 10 }]}>Total:</Text>
              <Text style={styles.grandTotalText}>${fmt(note.amount_total)} MXN</Text>
            </View>
            <View style={[styles.totalEntry, { borderTop: '1 solid #D1E1EF', marginTop: 4 }]}>
              <Text style={styles.label}>Pagado:</Text>
              <Text style={[styles.value, { color: paid > 0 ? '#15803D' : '#6B7280' }]}>
                ${fmt(note.amount_paid)} MXN
              </Text>
            </View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4 }}>
              <Text style={[styles.label, { fontWeight: 'bold', fontSize: 9 }]}>Saldo pendiente:</Text>
              <Text style={{ fontSize: 9, fontWeight: 'bold', color: balance <= 0 ? '#15803D' : '#EA580C' }}>
                ${fmt(note.amount_balance)} MXN
              </Text>
            </View>
          </View>
        </View>
